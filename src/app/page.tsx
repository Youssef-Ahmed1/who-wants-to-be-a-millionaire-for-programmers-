  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-slate-950 text-white p-4">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-slate-400">win your spot as a dev senior</p>
      </div>

      <Card className="w-full max-w-md bg-slate-900 border-slate-800">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl text-white">Select your path</CardTitle>
          <CardDescription className="text-slate-400">Choose your technical interview path.</CardDescription>
        </CardHeader>
        <CardContent className="flex flex-col gap-4">
          <Button  onClick={() => handleClick("Frontend Mastery")}
           variant="default" size="lg" className="w-full
            bg-blue-600 hover:bg-blue-700">
              Frontend Mastery</Button>
          ...
          <Button  onClick={() => handleClick("Full-Stack Gauntlet")}  variant="destructive" size="lg" className="w-full">Full-Stack mix</Button>
