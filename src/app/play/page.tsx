...
export default function GameBoard() {
    ...
    }, [timeLeft, selectedAnswer, isTimerActive, handleTimeout]);
 ...
 */
 ...
 const handleFiftyFifty = () => {
    ...
    const closeModal = (setModalState: (val: boolean) => void) => {
        setModalState(false);
                    ...
                    <div className="w-full max-w-4xl bg-slate-900/80 p-6 md:p-10 rounded-2xl border border-slate-800 shadow-2xl backdrop-blur-sm">
                        ...
                        <div className="flex flex-wrap gap-3 mb-6 justify-center">
                            <button
                                ...
                                className="bg-amber-500 hover:bg-amber-400 disabled:opacity-50 text-slate-900 font-bold py-2 px-4 rounded-lg text-sm md:text-base transition-colors"
                            >
                                rm -rf 50%
                            </button>
                            <button
                                ...
                                className="bg-[#009efa] hover:bg-blue-600 disabled:opacity-50 text-slate-900 font-bold py-2 px-4 rounded-lg text-sm md:text-base transition-colors"
                            >
                                Ask StackOverflow
                            </button>
                            <button
                                onClick={handlePhoneFriend}
                                disabled={usedPhoneFriend}
                                className="bg-[#845ec2] hover:bg-[#9b89b3] disabled:opacity-50 text-slate-900 font-bold py-2 px-4 rounded-lg text-sm md:text-base transition-colors"
                            >
                                📱 Phone a Friend
                            </button>
                        </div>
                ...
                {showAudienceModal && (
                    ...
                    >
                        <div className="bg-slate-900 border border-slate-700 p-8 rounded-2xl shadow-2xl w-full max-w-md">
                            ...
                            <button
                                onClick={() => closeModal(setShowAudienceModal)}
                ...
                {showPhoneModal && (
                    ...
                    >
                        <div className="bg-slate-900 border border-slate-700 p-8 rounded-2xl shadow-2xl w-full max-w-md">
                            ...
                            <button
                                onClick={() => closeModal(setShowPhoneModal)}
